...
var $author$project$Main$UrlReq = function (a) {
	return {$: 'UrlReq', a: a};
};
...
var $author$project$Main$msgElems = function (model) {
	return A2($elm$core$List$map, $mdgriffith$elm_ui$Element$text, model.messages);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$msgElems(model)),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_Nil,
						{
							label: $mdgriffith$elm_ui$Element$Input$labelHidden('Send a message..'),
							onChange: $author$project$Main$Draft,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
									$mdgriffith$elm_ui$Element$text('Send a message..'))),
							text: model.draft
						}),
						A2(
...
var $author$project$Main$seatCount = 10;
...
var $author$project$Main$playerStyle = _List_fromArray(
	[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]);
var $author$project$Main$tablePlayer = F2(
	function (offset_x, offset_y) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_Utils_ap(
				$author$project$Main$playerStyle,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$moveRight(offset_x),
						$mdgriffith$elm_ui$Element$moveDown(offset_y)
					])),
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text('Player'),
					$mdgriffith$elm_ui$Element$text('$1337')
				]));
	});
var $author$project$Main$seats = function () {
	var f = function (i) {
		var ang = ((2 * $elm$core$Basics$pi) * i) / $author$project$Main$seatCount;
		return $mdgriffith$elm_ui$Element$inFront(
			A2(
				$author$project$Main$tablePlayer,
				500 * $elm$core$Basics$sin(ang),
				250 * $elm$core$Basics$cos(ang)));
	};
	return A2(
		$elm$core$List$map,
		A2($elm$core$Basics$composeL, f, $elm$core$Basics$toFloat),
		A2($elm$core$List$range, 1, $author$project$Main$seatCount));
}();
...
var $author$project$Main$Raise = {$: 'Raise'};
var $author$project$Main$SetBet = function (a) {
	return {$: 'SetBet', a: a};
};
...
var $author$project$Main$inputRow = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				{
					label: $mdgriffith$elm_ui$Element$text('Fold'),
				...
				$author$project$Main$buttonStyle,
				{
					label: $mdgriffith$elm_ui$Element$text('Call'),
					onPress: $elm$core$Maybe$Nothing
				}),
				A2(
				$mdgriffith$elm_ui$Element$column,
				...
				_List_fromArray(
					[
						...
						{
							label: $mdgriffith$elm_ui$Element$Input$labelHidden('Raise amount'),
							onChange: $author$project$Main$SetBet,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
									$mdgriffith$elm_ui$Element$text(
										$elm$core$String$fromInt(model.minRaise)))),
							text: (!model.raiseAmt) ? '' : $elm$core$String$fromInt(model.raiseAmt)
						}),
						A2(
						$mdgriffith$elm_ui$Element$Input$button,
						$author$project$Main$buttonStyle,
						{
							label: $mdgriffith$elm_ui$Element$text('Raise'),
							onPress: $elm$core$Maybe$Just($author$project$Main$Raise)
						})
					]))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$inputRow(model)
					])),
...
var $author$project$Main$init = F3(
	function (_v0, _v1, _v2) {
		return _Utils_Tuple2(
			{draft: '', messages: _List_Nil, minRaise: 10, raiseAmt: 0},
			...
			case 'Send':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{draft: ''}),
					$author$project$Main$sendMessage(x));
			case 'SetBet':
				var x = msg.a;
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{init: $author$project$Main$init, onUrlChange: $author$project$Main$UrlChange, onUrlRequest: $author$project$Main$UrlReq, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$document});
